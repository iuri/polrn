###################################################################### 
#
# ]project-open[ V5.0 Configuration File
#
# - Using PostgreSQL 9.2
# - Using OpenACS 5.9.beta2
# - Using Naviserver 4.9.9
# - Assuming a SystemD configuration, so that
#   NaviServer is started after PostgreSQL is
#   operational
# 
###################################################################### 
